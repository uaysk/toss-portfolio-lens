...
const optimizationBase = z.object({
  ...
  currencyMode,
  objective: z.enum(["max_cagr", "max_total_return", "max_sharpe", "max_sortino", "max_calmar", "min_volatility", "min_cvar", "max_information_ratio", "robust_score"]).default("robust_score"),
...
export const toolSchemas = {
  ...
  compare_backtests: z.object({
    runIds: z.array(runId).min(2).max(20),
    allowMixedDataRevisions: z.boolean().default(false),
  }).strict(),
