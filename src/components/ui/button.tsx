...
function buttonVariants({
  ...
  return cn(
    BUTTON_BASE,
    variant === null ? undefined : BUTTON_VARIANTS[variant],
    size === null ? undefined : BUTTON_SIZES[size],
    className,
  );
}

export interface ButtonProps
  extends React.ButtonHTMLAttributes<HTMLButtonElement>, ButtonVariantOptions {
  asChild?: boolean;
}
